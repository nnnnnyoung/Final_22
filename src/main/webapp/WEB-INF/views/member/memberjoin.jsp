         ...
         <div class="row d-flex mb-5 contact-info">
            <div class="col-md-8 block-9 mb-md-5">
               <div id="joinform">
                  ...
                  <form class="form-group" action="memberinsert" method="POST"
                     id="formMem">
                     <div style="margin-bottom: 20px;">
                        <span style="padding-right: 100px;"><b>아이디</b></span> <span>
                           <input type="text" name="id" id="id" value="" autofocus required 
                           pattern="^[A-Za-z0-9]{8,10}$"/> <b>
                              *영문+숫자포함 8~10글자</b> <input type="text" hidden="" name="idChk" id="idChk" required>
                        </span>
                        <div id="errorId"></div>
                     </div>
                     <div style="margin-bottom: 20px;">
                        <span style="padding-right: 84px;"><b>비밀번호</b></span> <span><input
                           ...
                           pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{10,12}$"/> <b>
                     ...
                     <div style="margin-bottom: 20px;">
                        <span style="padding-right: 87px;"><b>전화번호</b></span> <span><input
                           type="tel" name="tel" id="tel" placeholder="010-0000-0000"
                     ...
                     <div style="margin-bottom: 20px;">
                        ...
                        <div style="margin-left: 150px;">
                           <input type="text" name="address" id="address"
                              placeholder="도로명 주소" style="width: 360px;" readonly />
                        </div>
                        <div style="margin-left: 150px;">
                           <input type="text" name="detailAddress" id="detailAddress"
                              placeholder="상세 주소" style="width: 360px;" required />
                        </div>
                        <div id="errorAddress"></div>
                     </div>
                     <div style="margin-bottom: 20px;">
                        <span style="padding-right: 110px;"><b>성 별</b></span> <span>남자<input
                           type="radio" name="gender" value="M" checked> 여자<input
                           type="radio" name="gender" value="W"></span>
                     </div>
                     <div style="margin-bottom: 20px;">
                        <span style="padding-right: 100px;"><b>이메일</b></span> <span>
                           <input type="text" name="emailId" id="emailId" required/> <input
                           id="domainTxt" type="text" name="domainTxt" required/> <select
...
<script type="text/javascript">
   ...
   /* 아이디 유효성 검사 및 중복 확인 */
   id.onkeyup = function(){   
      var regExpId =  /^[A-Za-z0-9]{8,10}$/; ;
      var idChk = document.getElementById('idChk');
      var errorId = document.getElementById('errorId');
      var testid=id.value;
      if(testid=="" ||regExpId.test(testid)==false){
         id.classList.add('invalid');         
         errorId.style="color:red;"
         errorId.innerHTML ="올바른 아이디 형식으로 입력하세요";
      } else {
         this.classList.add('invalid');
         $.ajax({
            url:'<%=request.getContextPath()%>/idchk?id='+id.value,
            type:'GET',
            cache:false,   // cache옵션값을 false로 주게 되면 브라우저 캐쉬를 막아서 캐쉬된 값이 아닌 현재 값을 호출해 올 수 있다.
            success: function(data){
               if(data!=""){
                  errorId.innerHTML = "사용 가능한 아이디 입니다.";
                  errorId.style="color:blue;"
                  idChk.value="true";
               } else if(data=="") {
                  errorId.style="color:red;"
                  errorId.innerHTML = "중복된 아이디 입니다.";
               }      
            }, error : function(){
               console.log("-----실패-------");
            }
   ...
   /* 아이디 통과하면 비밀번호 입력할 때 아이디 유효성 알려주는 문구 사라짐 */
