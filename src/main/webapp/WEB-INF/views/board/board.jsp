			...
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-8 text-center">
						...
						<h1>제주도로WE 이용후기</h1>
						<b>실 이용객들의 생생한 탑승후기</b>
						<h3>
							<a href="boardpo?id=${login_id}">[ 게시글등록 ]</a>
						</h3>
					</div>
								...
								<div style="margin-left: -20px;">
									<div class="post-entry-1-contents">
										...
										<span class="meta d-inline-block mb-30"
											...
											${bvo.bindate.substring(11,13)}시${bvo.bindate.substring(14,16)}분
											<span class="mx-4" style="font-size: 15px;">작성자<b
												style="font-size: 15px; color: #007bff;"> ${bvo.id}</b></span>
										</span> </span>
				...
				<div class="block-27">
					<ul>
						...
						<c:if test="${pageVO.prev}">
							<a href="boardview?page=${pageVO.startPage -1}">이전 </a>
						</c:if>

						<c:forEach begin="${pageVO.startPage}" end="${pageVO.endPage}"
							var="idx">
							<c:if test="${pageVO.page == idx}"></c:if>
							<li><a href="boardview?page=${idx}"}>${idx}</a></li>

						</c:forEach>
						<c:if test="${pageVO.next}">
							<a href="boardview?page=${pageVO.endPage +1}"> 다음 </a>
