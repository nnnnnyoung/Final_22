	...
	<section>
		...
		<div class="container site-section mb-5">
			<div id="wrap" align="center">
				<h1>게시글 수정</h1>
				<form id="modi" name="frm" method="post" action="modiAction"
					...
					<table>
						...
						<tr>
							...
							예약번호 ${rvo.cno } / 대여일
											...
											${rvo.returndate.substring(0, 10) }</td>
						...
						<tr>
							<th>내용</th>
							<td><textarea cols="70" rows="15" id="content" name="content">${bvo.content}</textarea></td>
						</tr>
						<tr>
							<th>첨부파일</th>
