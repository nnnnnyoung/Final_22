...
<nav
   ...
   <!-- 모달종료 -->
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
             <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>예약정보 <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">나의 예약리스트</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section">
      ...
      <section class="ftco-section ftco-intro" style="background-image: url(<%=request.getContextPath()%>/resources/images/bg_3.jpg);">
         <div class="overlay"></div>
         <div class="container">
